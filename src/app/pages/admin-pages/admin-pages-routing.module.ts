...
const routes: Routes = [
  ...
  {path: 'board', component: pages.AdminIndexArticlePageComponent, canActivate: [AuthGuard]},
  ...
  {
    path: 'articles/:id/createContent',
    component: pages.AdminCreateArticleContentPageComponent,
